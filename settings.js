...
global.owner = [process.env.OWNER_NUMBER] || ['94713317339'] // Owner number , (අයිතිකරුගේ නම්බර් එක )
...
WORK_TYPE: process.env.WORK_TYPE || 'bublic'  ,
ANTI_LINK: process.env.ANTI_LINK || false  ,
ANTI_BOT: process.env.ANTI_BOT || false  ,
OWNER_NUMBER: process.env.OWNER_NUMBER || '94713317339'  ,    
ALIVE: process.env.ALIVE || `default`,
OWNER_NAME: process.env.OWNER_NAME || '𝙶𝙸𝙼𝙷𝙰𝙽☠️⚠️' ,     
